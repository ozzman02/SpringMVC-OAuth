    <head>
	    ...
	    <link href="<%=request.getContextPath()%>/vendor/devicons/css/devicons.min.css" rel="stylesheet">
	    <link href="<%=request.getContextPath()%>/vendor/simple-line-icons/css/simple-line-icons.css" rel="stylesheet">
	
	    <!-- Custom styles for this template -->
	    <link href="<%=request.getContextPath()%>/css/resume.min.css" rel="stylesheet">
    </head>